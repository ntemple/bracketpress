jQuery(function(){
	...
	// Ajax Login
	jQuery('.widget_wp_bracketpresslogin form').submit(function(){
	    ...
	    var data = {
			action: 		'bracketpress_login_process',
			security: 		bracketpress_login_params.login_nonce,
		...
		// Ajax action
		jQuery.ajax({
			url: bracketpress_login_params.ajax_url,
			data: data,
			type: 'GET',
			dataType: 'jsonp',
