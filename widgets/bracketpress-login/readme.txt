# Original README from sidebar-login. 
# Note: translations have been removed
...
BracketPress-Login has both a widget and a template tag to allow you to have a login form in the sidebar of your wordpress powered blog.
...
You can configure the plugin in <code>Admin > Settings > BracketPress Login</code> after installing it.
...
= First time installation instructions =
   ...
   4. To use the template tag: Add &lt;?php bracketpresslogin(); ?&gt; to your template.
   
= Configuration =

You will find a config page in tools/settings > BracketPress Login. Here you can set links and redirects up.
...
= 2.3.1 = 
*	Error loop fix
*	Added filter for errors - bracketpress_login_error
